	...
	public static void main (String[] args) {
		...
		if (SharedLibraryLoader.isWindows) {
			if (System.getProperties().getProperty("os.name").equals("Windows XP")) {
				basePath = "Application Data/.shatteredpixel/Clairvoyant Pixel Dungeon/";
			} else {
				basePath = "AppData/Roaming/.shatteredpixel/Clairvoyant Pixel Dungeon/";
			}
		} else if (SharedLibraryLoader.isMac) {
			basePath = "Library/Application Support/Clairvoyant Pixel Dungeon/";
		} else if (SharedLibraryLoader.isLinux) {
			basePath = ".shatteredpixel/clairvoyant-pixel-dungeon/";
		}
