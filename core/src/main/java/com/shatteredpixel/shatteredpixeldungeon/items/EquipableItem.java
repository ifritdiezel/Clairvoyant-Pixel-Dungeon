...
public abstract class EquipableItem extends Item {
	...
	public static void equipCursed( Hero hero ) {
		...
		if ((Dungeon.hero.className().equals("apprentice")&&Dungeon.hero.lvl <= 15) ){
			Buff.affect(Dungeon.hero, Terror.class, 30);
			Buff.affect(Dungeon.hero, Vertigo.class, 30);
			Buff.affect(Dungeon.hero, Paralysis.class, 3);
	}}
