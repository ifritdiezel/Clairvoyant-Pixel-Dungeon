...
public class Alchemize extends Spell implements AlchemyScene.AlchemyProvider {
	...
	public int getEnergy() {
		return (int) (curUser.pointsInTalent(Talent.OPTIMIZED_TRANSMUTATION)+1.5);
	}
	...
	public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe {

		{
			...
			cost = 6- Dungeon.hero.pointsInTalent(Talent.OPTIMIZED_TRANSMUTATION);
			
			output = Alchemize.class;
			outQuantity = 4+Dungeon.hero.pointsInTalent(Talent.OPTIMIZED_TRANSMUTATION);
		}
