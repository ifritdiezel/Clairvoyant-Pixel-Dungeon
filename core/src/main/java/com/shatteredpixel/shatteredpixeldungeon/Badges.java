...
public class Badges {
	...
	public static void validateBossSlain() {
		...
		if (badge != null) {
			...
			if (badge == Badge.BOSS_SLAIN_1) {
				...
				case APPRENTICE:
					badge = Badge.BOSS_SLAIN_1_APPRENTICE;
					break;
				case MAGE:
				...
				if (global.contains( Badge.BOSS_SLAIN_1_APPRENTICE ) &&
			...
			if (badge == Badge.BOSS_SLAIN_3) {
				...
				case CHANNELLER:
					badge = Badge.BOSS_SLAIN_3_CHANNELLER;
					break;
				//case BERSERKER:
				...
				if (global.contains( Badge.BOSS_SLAIN_3_CHANNELLER ) &&
	...
	public static void validateMastery() {
		...
		switch (Dungeon.hero.heroClass) {
		case APPRENTICE:
			badge = Badge.MASTERY_APPRENTICE;
			break;
		case MAGE:
	...
	public static void validateVictory() {
		...
		switch (Dungeon.hero.heroClass) {
		case APPRENTICE:
			badge = Badge.VICTORY_APPRENTICE;
			break;
		case MAGE:
		...
		if (global.contains( Badge.VICTORY_APPRENTICE ) &&
