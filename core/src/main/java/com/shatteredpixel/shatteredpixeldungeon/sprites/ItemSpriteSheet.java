...
public class ItemSpriteSheet {
	...
	public static final int SPELL_HAND      = WEP_TIER1+6;
	public static final int EIGHTERSTAFF    = WEP_TIER1+7;
	static{
		assignItemRect(WORN_SHORTSWORD, 13, 13);
		assignItemRect(GLOVES,          12, 16);
		assignItemRect(DAGGER,          12, 13);
		assignItemRect(MAGES_STAFF,     15, 16);
		assignItemRect(SPELL_HAND,      12, 16);
		assignItemRect(EIGHTERSTAFF,	12, 12);
	}
	...
	public static final int POWER_BRACELET  = WEP_TIER3+6;
	static{
		...
		assignItemRect(POWER_BRACELET,  13, 14);
	}
	...
	public static final int ARMOR_APPRENTICE   = ARMOR+5;
	...
	static{
		...
		assignItemRect(ARMOR_APPRENTICE,   12, 12);
	...
	public static final int POTION_WEIRD = POTIONS+14;
	static {
	...
	private static final int DEBUG_ITEMS       =                                   xy(1, 32);  //16 slots
	public static final int SCROLL_DOWN   = DEBUG_ITEMS+0;
	public static final int SCROLL_UP     = DEBUG_ITEMS+1;
	static{
		assignItemRect(SCROLL_DOWN, 15, 14);
		assignItemRect(SCROLL_UP, 15, 14);
	}
	...
	public static class Icons {
		...
		public static final int POTION_HTR  	= POTIONS+12;
		static {
